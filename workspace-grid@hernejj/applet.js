...
function switchWorkspace(display, window, binding) {
    let current_workspace_index = global.screen.get_active_workspace_index();

    let binding_name = binding.get_name();
    if (binding_name == 'switch-to-workspace-left')
        Main.wm.actionMoveWorkspaceLeft();
    else if (binding_name == 'switch-to-workspace-right')
        Main.wm.actionMoveWorkspaceRight();
    else if (binding_name == 'switch-to-workspace-up')
        Main.wm.actionMoveWorkspaceUp();
    else if (binding_name == 'switch-to-workspace-down')
